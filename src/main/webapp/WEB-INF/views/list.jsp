	      ...
	      <div class="container">
	        ...
	        <div class="collapse navbar-collapse" id="navbarNav">
	          <ul class="navbar-nav">
	            ...
	            <li class="nav-item">
	              <a class="nav-link" href="/instagram-clone/detail?name=${user}">
			                              ...
			                              <p class="card-text">
			                                  ...
			                                  <c:choose> 
			                                     <c:when test="${post.like eq true}">
			                                     	 ...
			                                     	 <a class="btn btn-primary btn-lg" href="likesdelete?id=${post.id}"class="recommend btn btn-sm btn-secondary btn-block my-1" style="width:45%;">
			                                          	 	<h5>
			                                          	 	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
			                                                  <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>
			                                                </svg>	
			                                     ...
			                                     <c:otherwise>
			                                          	 ...
			                                          	 <a class="btn btn-primary btn-lg" href="likes?id=${post.id}" class="recommend btn btn-sm btn-secondary btn-block my-1" style="width:45%;">
			                                          	 	<h5>
