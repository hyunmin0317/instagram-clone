...
<html lang="ko">
  <head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://raw.githubusercontent.com/hyunmin0317/facebook-clone/3eeb259ea74cfe1ab81b21da1a5aeca989686f84/static/facebook.svg">
    <!-- Bootstrap CSS -->
	   ...
	   <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	      <div class="container">
	        ...
	        <div class="collapse navbar-collapse" id="navbarNav">
	          <ul class="navbar-nav">
	            <li class="nav-item">
	              <a class="nav-link" href="{% url 'facebook:post_create' %}">
			                          ...
			                          <div class="card shadow-sm">
			                              ...
			                              <div class="card-body">
			 								...
			 								<h4>${post.title }</h4>
			                                  ...
			                                  <c:if test="${sessionScope.isAdmin == 'true'}"><a href="./post/delete?id=${post.postId}">삭제</a><br><br></c:if>
			                              </div>
			                          </div>
			                      </div>
			                  </div>
